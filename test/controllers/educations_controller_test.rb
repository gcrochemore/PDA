...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { begin_date: @education.begin_date, end_date: @education.end_date, name: @education.name, resume_id: @education.resume_id, scholl: @education.scholl } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { begin_date: @education.begin_date, end_date: @education.end_date, name: @education.name, resume_id: @education.resume_id, scholl: @education.scholl } }

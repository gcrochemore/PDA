...
class WorkExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_experience" do
    assert_difference('WorkExperience.count') do
      post work_experiences_url, params: { work_experience: { begin_date: @work_experience.begin_date, end_date: @work_experience.end_date, name: @work_experience.name, resume_id: @work_experience.resume_id, scholl: @work_experience.scholl } }
    end
  ...
  test "should update work_experience" do
    patch work_experience_url(@work_experience), params: { work_experience: { begin_date: @work_experience.begin_date, end_date: @work_experience.end_date, name: @work_experience.name, resume_id: @work_experience.resume_id, scholl: @work_experience.scholl } }
